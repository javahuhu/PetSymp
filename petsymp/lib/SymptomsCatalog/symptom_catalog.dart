final Map<String, dynamic> symptomCatalog = {
  ...
  "Cataracts": {
    "Description": ["A clouding of the eye’s lens that causes vision impairment. Common in aging pets and those with diabetes."]
  },
  "Chronic Pain": {
  ...
  "Dry Coughing": {
    "Description": ["A harsh, non-productive cough that doesn’t bring up mucus. Often seen with kennel cough, allergies, or throat irritation."]
  },
  "Dull Coat": {
  ...
  "Inflammation": {
    "Description": ["Redness, heat, and swelling of tissues. It’s a general immune response to injury, infection, or irritation."]
  },
  ...
  "Pale Gums": {
    "Description": ["Light pink to white gums may suggest anemia, shock, or poor circulation. It’s often a sign of a serious internal issue."]
  },
  "Panting": {
  ...
  "Sneezing": {
    "Description": ["A sudden burst of air from the nose. It’s a reflex to remove irritants and can be caused by allergies, dust, or infections."]
  },
  "Sores": {
